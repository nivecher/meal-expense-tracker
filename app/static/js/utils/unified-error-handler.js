...
(function() {
  ...
  window.addEventListener(
    ...
    (event) => {
      ...
      if (
        errorMessage.includes('tagName.toLowerCase is not a function') ||
  ...
  console.error = function(...args) {
    ...
    if (message.includes('tagName.toLowerCase is not a function') || message.includes('bootstrap-autofill')) {
      return; // Suppress
    }
