...
Revision ID: 37dd0c2068d8
Revises:
Create Date: 2025-11-16 09:01:18.466419
...
def upgrade():
    ...
    op.create_table(
        ...
        sa.Column("website", sa.String(length=500), nullable=True, comment="Restaurant website URL"),
