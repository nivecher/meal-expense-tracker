...
def test_expense_export(client, app, auth, test_user) -> None:
    ...
    header = '"date","cleared_date","time_utc","datetime_utc","amount","meal_type","order_type","party_size","notes","category_name","restaurant_name","restaurant_address","restaurant_city","restaurant_state","restaurant_postal_code","restaurant_country","restaurant_google_place_id","tags","created_at","updated_at"'
